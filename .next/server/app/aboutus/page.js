...
`;function OtherInfo({otherInfo:e={}}){let{description:t="",cta:i={}}=e||{},{text:r="",link:n=""}=i||{};return(0,a.jsxs)(m,{children:[a.jsx("label",{className:"description",children:t}),a.jsx("div",{className:"button-container",children:a.jsx("label",{className:"button-text",children:r})})]})}let u=s.ZP.div`
    display: flex;
    flex-direction: column;
