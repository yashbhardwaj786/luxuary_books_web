...
`;function OtherInfo({otherInfo:e={}}){let{description:t="",cta:i={}}=e||{},{text:n="",link:r=""}=i||{};return(0,a.jsxs)(u,{children:[a.jsx("label",{className:"description",children:t}),a.jsx("div",{className:"button-container",children:a.jsx("label",{className:"button-text",children:n})})]})}let m=s.ZP.div`
    display: flex;
    flex-direction: column;
