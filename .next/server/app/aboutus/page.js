...
`;var d=i(1605);function AuthorImage({imageUrl:e="",title:t="",description:i=""}){return(0,d.k)(),(0,a.jsxs)(l,{children:[a.jsx("div",{className:"bg-circle-container",children:a.jsx("img",{src:e,className:"bg-author-image"})}),a.jsx("label",{className:"title-text",children:t}),i.split("\n").map((e,t)=>a.jsx(r().Fragment,{children:a.jsx("label",{className:"description-text",children:e})},t))]})}let c=s.ZP.div`
    display: flex;
    flex-direction: column;
...
`;var m=i(2342),x=i.n(m);let h=s.ZP.div`
    display: flex;
    flex-direction: column;
...
`;var f=i(860);let Star=({filled:e,isMobile:t})=>a.jsx(a.Fragment,{children:t?a.jsx("img",{src:e?"./images/FilledStarMobile.svg":"./images/EmptyStarMobile.svg",alt:e?"Filled Star":"Empty Star",style:{display:"inline-block"}}):a.jsx("img",{src:e?"./images/FilledStar.svg":"./images/EmptyStar.svg",alt:e?"Filled Star":"Empty Star",style:{display:"inline-block"}})}),StarRating=({rating:e,isMobile:t})=>{let i=Math.floor(e),n=e-i>=.5,r=[];for(let e=0;e<i;e++)r.push(a.jsx(Star,{filled:!0,isMobile:t},e));n&&r.push(a.jsx(Star,{filled:!1,isMobile:t},i));let s=5-i-(n?1:0);for(let e=0;e<s;e++)r.push(a.jsx(Star,{filled:!1,isMobile:t},i+(n?1:0)+e));return a.jsx("div",{children:r})},testimonials_StarRating=({isMobile:e=!1,rating:t=0})=>a.jsx("div",{children:a.jsx(StarRating,{rating:t,isMobile:e})});var b=i(3011);function TestimonialsPage({testimonials:e={},isMobile:t=!1}){let{title:i="",reviews:n=[]}=e||{};return(0,a.jsxs)(h,{children:[a.jsx("div",{className:"blur-background"}),a.jsx("label",{className:"title-text ",children:i}),t?a.jsx(b.Z,{scrollWidth:1,scrollDuration:100,children:n.map((e,i)=>{if(!e)return null;let{name:n="",lastUpdated:r="",description:s="",rating:o=0}=e;return a.jsx(g,{children:(0,a.jsxs)("div",{className:"inner-cover-area",children:[a.jsx(testimonials_StarRating,{isMobile:t,rating:o}),(0,a.jsxs)("div",{className:"text-container",children:[a.jsx("img",{src:"./images/shape_quotes_mobile.svg",className:"quote-image"}),a.jsx("label",{className:"review-title",children:s})]}),(0,a.jsxs)("div",{className:"user-info-container",children:[a.jsx("label",{className:"user-name",children:n}),a.jsx("label",{className:"user-occupation",children:r})]})]})},i)})}):a.jsx(f.ZP,{slidesToShow:1,slidesToScroll:1,hideBlur:!0,children:n.map((e,i)=>{if(!e)return null;let{name:n="",lastUpdated:r="",description:s="",rating:o=0}=e;return a.jsx(g,{children:(0,a.jsxs)("div",{className:"inner-cover-area",children:[a.jsx(testimonials_StarRating,{isMobile:t,rating:o}),(0,a.jsxs)("div",{className:"text-container",children:[a.jsx("img",{src:"./images/shape_quotes.svg",className:"quote-image"}),a.jsx("label",{className:"review-title",children:s})]}),(0,a.jsxs)("div",{className:"user-info-container",children:[a.jsx("label",{className:"user-name",children:n}),a.jsx("label",{className:"user-occupation",children:r})]})]})},i)})})]})}let y={errorCode:200,success:!0,message:"",result:{title:"About Author",imageUrl:"/images/author_img.jpeg",description:"Kshamta is an author, poetess, dentist, teacher, mum, cook and a Tolkien fan. Karma Sagas - The Sangam is her first book and she intends to write at least a few more. Her interest in consciousness, sustainability and climate change has led her to explore science, spirituality and philosophy. It was all getting a bit too serious so she thought why not bring it all together into an entertaining story? When she is not busy figuring out treatment plans or lost in a fantasy land, she loves talking to her son about all things science. Born not too far from the Thar desert in North India, she now calls North Yorkshire her home. She blames the serene and picturesque surroundings to make her want to write – a desire that had been peacefully sleeping since she was fourteen. But before that, she would make up stories and songs and even recite her poetry unabashedly at every opportunity.",usefulLinks:[{title:"Contact Information",link:"/contactus"},{title:"Frequently Asked Questions",link:"/contactus#faqsection"},{title:"Glossary of terms",link:`/bookdetails?bookName=${encodeURIComponent("Karma Sagas The Sangam: 1")}#grossaryoftermssection`}],otherInfo:{description:`Born in Jaipur, the pink city of India, I am the second oldest of four siblings. We were a
