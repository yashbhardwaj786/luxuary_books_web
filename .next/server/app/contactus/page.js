...
`;var x=a(1605);function AuthorImage({imageUrl:e="",title:t="",description:a=""}){return(0,x.k)(),(0,i.jsxs)(l,{children:[i.jsx("div",{className:"bg-circle-container",children:i.jsx("img",{src:e,className:"bg-author-image"})}),i.jsx("label",{className:"title-text",children:t}),a.split("\n").map((e,t)=>i.jsx(r().Fragment,{children:i.jsx("label",{className:"description-text",children:e})},t))]})}let p=s.ZP.div`
    display: flex;
    flex-direction: column; 
    flex-wrap: wrap;
    padding: 30px;
