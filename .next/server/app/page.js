...
`,s=a.ZP.div`
  ...
  `;var c=o(3011),p=o(1605),g=o(2342),m=o.n(g);function BannerContent({bannerData:e=[],exploreBookClick:t=m()}){let o=(0,p.k)(),a=(0,n.useCallback)(e=>{t(e)},[]);return r.jsx(l,{children:o?r.jsx(c.Z,{scrollWidth:1,scrollDuration:100,children:e.map((e,t)=>{if(!e)return null;let{bookImage:o="",cta:n={}}=e,{text:i="",link:l=""}=n;return(0,r.jsxs)(s,{children:[r.jsx("div",{className:"book__img",children:r.jsx("img",{src:o,alt:"book-image"})}),r.jsx("div",{className:"button-container",onClick:e=>{e.preventDefault(),e.stopPropagation(),a(l)},children:r.jsx("label",{className:"button-text",children:i})})]},t)})}):r.jsx(i.ZP,{slidesToShow:1,slidesToScroll:1,hideBlur:!0,children:e.map((e,t)=>{if(!e)return null;let{bookImage:o="",title:n="",description:i="",cta:l={}}=e,{text:c="",link:p=""}=l;return(0,r.jsxs)(s,{children:[r.jsx("div",{className:"book__img",children:r.jsx("img",{src:o,alt:"luxary-book"})}),r.jsx("label",{className:"book-title",children:n}),r.jsx("label",{className:"book-subtitle",children:i}),r.jsx("div",{className:"button-container",onClick:e=>{e.preventDefault(),e.stopPropagation(),a(p)},children:r.jsx("label",{className:"button-text",children:c})})]},t)})})})}let d=a.ZP.div`
    display: flex;
    flex-direction: row;
...
`;function BookJourneyOddItem({journey:e={}}){let{bookImageUrl:t="",title:o="",description:n="",cta:i={}}=e||{},{text:a="",link:l=""}=i||{};return(0,r.jsxs)(x,{children:[(0,r.jsxs)("div",{className:"book-details-container",children:[r.jsx("label",{className:"book-journey-title",children:o}),r.jsx("label",{className:"book-journey-subtitle",children:n}),r.jsx("div",{className:"book-journey-button-container",children:r.jsx("label",{className:"book-journey-button-text",children:a})})]}),r.jsx("img",{className:"book-item-image",src:t})]})}let b=a.ZP.div`
    display: flex;
    margin-left: 126px;
    background-repeat: no-repeat;
    background-image: url('/images/character_bg.png');
