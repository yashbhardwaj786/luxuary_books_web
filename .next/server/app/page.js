...
`,s=i.ZP.div`
  ...
  `;var c=o(3011),p=o(1605),g=o(2342),d=o.n(g);function BannerContent({bannerData:e=[],bannerWelcome:t="",exploreBookClick:o=d()}){let i=(0,p.k)(),g=(0,n.useCallback)(e=>{o(e)},[]);return(0,a.jsxs)(l,{children:[a.jsx("label",{className:"banner-content-welcome-text",children:t}),i?a.jsx(c.Z,{scrollWidth:1,scrollDuration:100,children:e.map((e,t)=>{if(!e)return null;let{bookImage:o="",cta:n={}}=e,{text:r="",link:i=""}=n;return(0,a.jsxs)(s,{children:[a.jsx("div",{className:"book__img",children:a.jsx("img",{loading:"eager",src:o,alt:"book-image"})}),a.jsx("div",{className:"button-container",onClick:e=>{e.preventDefault(),e.stopPropagation(),g(i)},children:a.jsx("label",{className:"button-text",children:r})})]},t)})}):a.jsx(r.ZP,{slidesToShow:1,slidesToScroll:1,hideBlur:!0,children:e.map((e,t)=>{if(!e)return null;let{bookImage:o="",title:n="",description:r="",cta:i={}}=e,{text:l="",link:c=""}=i;return(0,a.jsxs)(s,{children:[a.jsx("div",{className:"book__img",children:a.jsx("img",{src:o,alt:"luxary-book",loading:"eager"})}),a.jsx("label",{className:"book-title",children:n}),a.jsx("label",{className:"book-subtitle",children:r}),a.jsx("div",{className:"button-container",onClick:e=>{e.preventDefault(),e.stopPropagation(),g(c)},children:a.jsx("label",{className:"button-text",children:l})})]},t)})})]})}let m=i.ZP.div`
    display: flex;
    flex-direction: row;
...
`;function BookJourneyOddItem({character:e={}}){let{bookImageUrl:t="",title:o="",description:n="",cta:r={}}=e||{},{text:i="",link:l=""}=r||{};return(0,a.jsxs)(b,{children:[(0,a.jsxs)("div",{className:"book-details-container",children:[a.jsx("label",{className:"book-journey-title",children:o}),a.jsx("label",{className:"book-journey-subtitle",children:n})]}),a.jsx("img",{loading:"lazy",className:"book-item-image",src:t})]})}let u=i.ZP.div`
    display: flex;
    margin-left: 126px;
    background-repeat: no-repeat;
    background-image: url('/images/character_bg.webp');
...
`;function BookJourneyEvenItem({character:e={}}){let{bookImageUrl:t="",title:o="",description:n="",cta:r={}}=e||{},{text:i="",link:l=""}=r||{};return(0,a.jsxs)(u,{children:[a.jsx("img",{loading:"lazy",className:"book-item-image",src:t}),(0,a.jsxs)("div",{className:"book-details-container",children:[a.jsx("label",{className:"book-journey-title",children:o}),a.jsx("label",{className:"book-journey-subtitle",children:n})]})]})}let h=i.ZP.div`
    display: flex;
    flex-direction: column;
    padding: 30px;
    width: 100%;
...
`;function BookJourneyEvenComponent({character:e={}}){let{bookImageUrl:t="",title:o="",description:n="",cta:r={}}=e||{},{text:i="",link:l=""}=r||{};return(0,a.jsxs)(h,{children:[a.jsx("img",{loading:"lazy",src:t,className:"book-item-image"}),a.jsx("label",{className:"book-journey-title",children:o}),a.jsx("label",{className:"book-journey-subtitle",children:n})]})}let f=i.ZP.div`
    display: flex;
    flex-direction: column;
    padding-top: 30px;
    width: 100%;
...
`;function BookJourneyOddComponent({character:e={}}){let{bookImageUrl:t="",title:o="",description:n="",cta:r={}}=e||{},{text:i="",link:l=""}=r||{};return(0,a.jsxs)(f,{children:[a.jsx("img",{loading:"lazy",src:t,className:"book-item-image"}),a.jsx("label",{className:"book-journey-title",children:o}),a.jsx("label",{className:"book-journey-subtitle",children:n})]})}function BookJourney({bookJourney:e={},learnMoreClick:t=d()}){let o=(0,p.k)(),{characters:r=[],cta:i={},headerText:l=""}=e||{},{text:s="",link:c=""}=i||{},g=(0,n.useCallback)(e=>{t(e)},[]);return(0,a.jsxs)(x,{children:[a.jsx("label",{className:"header-text",children:l}),o?a.jsx("div",{className:"bgContainer",children:r.map((e,t)=>{if(!e)return null;let o=t%2==0;return a.jsx("div",{children:o?a.jsx(BookJourneyEvenComponent,{character:e}):a.jsx(BookJourneyOddComponent,{character:e})},t)})}):a.jsx("div",{className:"bgContainer",children:r.map((e,t)=>{if(!e)return null;let o=t%2==0;return a.jsx("div",{children:o?a.jsx(BookJourneyEvenItem,{character:e}):a.jsx(BookJourneyOddItem,{character:e})},t)})}),a.jsx("div",{className:"book-journey-button-container",onClick:e=>{e.preventDefault(),e.stopPropagation(),g(c)},children:a.jsx("label",{className:"book-journey-button-text",children:s})})]})}let k={result:{bannerWelcome:"Welcome! Here you can learn a bit more about Kshamta and her first novel.",bannerData:[{bookImage:"/images/book_image.webp",cta:{text:"The Story",link:"/bookdetails?bookName=${encodeURIComponent('Karma Sagas The Sangam: 1')}"}}],aboutBook:{logoImage:"logoUrlor add it to static",cta:{text:"Learn More",link:"/aboutus"}},bookJourney:{headerText:"The Characters and places",cta:{text:"Get the book",link:"/shop"},characters:[{bookImageUrl:"/images/joash_pundit.webp",title:"Joash Pundit",description:"Joash Pundit - a science journalist. Torn between the past and future, science and mysticism, will he find the answers?",backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/Krupa.webp",title:"Krupa",description:"Krupa, a feisty yogini, lives in a monastery (the Ashram) in the Himalayas.",backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/Swamiji.webp",title:"Swamiji",description:"Swamiji is Krupa's spiritual teacher and the head of the Ashram.",backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/tejas.webp",title:"Tejas",description:"Tejas is the yogini who knows fire, she lives deep in the jungles.",backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/Callum_Bailey.webp",title:"Callum",description:"Callum is a bright teenager from Glasgow, with a sunshine smile, he spreads happiness wherever he goes.",backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/Jaggu_baba.webp",title:"Jaggu Baba",description:"Jaggu Baba is an enigma, no one can understand what he really wants.",backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/book_bg_odd.webp",title:"London reeling",description:"London reeling with relentless rains, this is where the story begins.",backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/book_bg_even.webp",title:"The Himalayas",description:"The Himalayas near Jispa.",backgroundImageUrl:"somebackgroundImageURL"}]}}},y=i.ZP.div`
    display: flex;
    flex-direction: column;
  `;function HomeLandingPage(e){let{learnMoreClick:t=d(),exploreBookClick:o=d()}=e.actions||{},{bannerWelcome:n="",bannerData:r=[],aboutBook:i={},bookJourney:l={}}=k.result;return(0,a.jsxs)(y,{children:[a.jsx(BannerContent,{exploreBookClick:o,bannerData:r,bannerWelcome:n}),a.jsx(AboutBook,{learnMoreClick:t,aboutBook:i}),a.jsx(BookJourney,{bookJourney:l,learnMoreClick:t})]})}var j=o(3285);o(5520);let skeltonhomepage=()=>(0,a.jsxs)("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",padding:"20px"},children:[a.jsx(j.Z,{height:20,width:570,style:{marginBottom:"20px"}}),a.jsx(j.Z,{height:350,width:400,style:{marginBottom:"20px"}}),a.jsx(j.Z,{height:40,width:100})]}),v=i.ZP.div`

    display: flex;
    flex-direction: column;

`;var w=o(7114),C=o(2142);function Home(){let e=(0,w.useRouter)(),t=(0,n.useCallback)(t=>{e.push(t)},[]),o=(0,n.useCallback)(t=>{e.push(t)},[]),r=(0,n.useMemo)(()=>({learnMoreClick:t,exploreBookClick:o}),[t,o]),[i,l]=(0,n.useState)(!0),s=(0,n.useRef)(null);return((0,n.useEffect)(()=>{s.current=setTimeout(()=>{l(!1)},500)},[]),i)?a.jsx(skeltonhomepage,{}):(0,a.jsxs)(a.Fragment,{children:[a.jsx(v,{children:a.jsx(HomeLandingPage,{actions:r})}),a.jsx(C.Z,{})]})}},6768:(e,t,o)=>{"use strict";o.r(t),o.d(t,{$$typeof:()=>i,__esModule:()=>r,default:()=>s});var a=o(7536);let n=(0,a.createProxy)(String.raw`/Users/yashbhardwaj/Documents/luxuary_books_web/src/app/page.tsx`),{__esModule:r,$$typeof:i}=n,l=n.default,s=l}};var t=require("../webpack-runtime.js");t.C(e);var __webpack_exec__=e=>t(t.s=e),o=t.X(0,[879,104,405,681,66,168,763],()=>__webpack_exec__(7796));module.exports=o})();