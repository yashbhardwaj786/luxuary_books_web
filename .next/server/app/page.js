...
`,s=i.ZP.div`
  ...
  `;var c=t(3011),p=t(1605),g=t(2342),d=t.n(g);function BannerContent({bannerData:e=[],exploreBookClick:o=d()}){let t=(0,p.k)(),i=(0,a.useCallback)(e=>{o(e)},[]);return n.jsx(l,{children:t?n.jsx(c.Z,{scrollWidth:1,scrollDuration:100,children:e.map((e,o)=>{if(!e)return null;let{bookImage:t="",cta:a={}}=e,{text:r="",link:l=""}=a;return(0,n.jsxs)(s,{children:[n.jsx("div",{className:"book__img",children:n.jsx("img",{src:t,alt:"book-image"})}),n.jsx("div",{className:"button-container",onClick:e=>{e.preventDefault(),e.stopPropagation(),i(l)},children:n.jsx("label",{className:"button-text",children:r})})]},o)})}):n.jsx(r.ZP,{slidesToShow:1,slidesToScroll:1,hideBlur:!0,children:e.map((e,o)=>{if(!e)return null;let{bookImage:t="",title:a="",description:r="",cta:l={}}=e,{text:c="",link:p=""}=l;return(0,n.jsxs)(s,{children:[n.jsx("div",{className:"book__img",children:n.jsx("img",{src:t,alt:"luxary-book"})}),n.jsx("label",{className:"book-title",children:a}),n.jsx("label",{className:"book-subtitle",children:r}),n.jsx("div",{className:"button-container",onClick:e=>{e.preventDefault(),e.stopPropagation(),i(p)},children:n.jsx("label",{className:"button-text",children:c})})]},o)})})})}let m=i.ZP.div`
    display: flex;
    flex-direction: row;
...
`;function BookJourneyEvenComponent({journey:e={},learnMoreClick:o=d()}){let{bookImageUrl:t="",title:r="",description:i="",cta:l={}}=e||{},{text:s="",link:c=""}=l||{},p=(0,a.useCallback)(e=>{o(e)},[]);return(0,n.jsxs)(h,{children:[n.jsx("img",{src:t,className:"book-item-image"}),n.jsx("label",{className:"book-journey-title",children:r}),n.jsx("label",{className:"book-journey-subtitle",children:i}),n.jsx("div",{className:"book-journey-button-container",onClick:e=>{e.preventDefault(),e.stopPropagation(),p(c)},children:n.jsx("label",{className:"book-journey-button-text",children:s})})]})}let k=i.ZP.div`
    display: flex;
    flex-direction: column;
    padding-top: 30px;
    width: 100%;
...
`;function BookJourneyOddComponent({journey:e={},learnMoreClick:o=d()}){let{bookImageUrl:t="",title:r="",description:i="",cta:l={}}=e||{},{text:s="",link:c=""}=l||{},p=(0,a.useCallback)(e=>{o(e)},[]);return(0,n.jsxs)(k,{children:[n.jsx("img",{src:t,className:"book-item-image"}),n.jsx("label",{className:"book-journey-title",children:r}),n.jsx("label",{className:"book-journey-subtitle",children:i}),n.jsx("div",{className:"book-journey-button-container",onClick:e=>{e.preventDefault(),e.stopPropagation(),p(c)},children:n.jsx("label",{className:"book-journey-button-text",children:s})})]})}function BookJourney({bookJourney:e=[],learnMoreClick:o=d()}){let t=(0,p.k)();return n.jsx(u,{children:t?n.jsx("div",{className:"bgContainer",children:e.map((e,t)=>{if(!e)return null;let a=t%2==0;return n.jsx("div",{children:a?n.jsx(BookJourneyEvenComponent,{journey:e,learnMoreClick:o}):n.jsx(BookJourneyOddComponent,{journey:e,learnMoreClick:o})},t)})}):n.jsx("div",{className:"bgContainer",children:e.map((e,t)=>{if(!e)return null;let a=t%2==0;return n.jsx("div",{children:a?n.jsx(BookJourneyEvenItem,{journey:e,learnMoreClick:o}):n.jsx(BookJourneyOddItem,{journey:e,learnMoreClick:o})},t)})})})}let f={result:{bannerData:[{bookImage:"/images/book_image.jpg",cta:{text:"Explore the book",link:"/bookdetails?bookName=${encodeURIComponent('Karma Sagas The Sangam: 1')}"}}],aboutBook:{logoImage:"logoUrlor add it to static",cta:{text:"Learn More",link:"/aboutus"}},bookJourney:[{bookImageUrl:"/images/joash_pundit.jpeg",title:"Joash Pundit",description:"Joash Pundit - a science journalist. Torn between the past and future, science and mysticism, will he find the answers?",cta:{text:"Get the book",link:"/shop"},backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/Krupa.png",title:"Krupa",description:"Krupa, a feisty yogini, lives in a monastery (the Ashram) in the Himalayas.",cta:{text:"Get the book",link:"/shop"},backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/Swamiji.png",title:"Swamiji",description:"Swamiji is Krupa's spiritual teacher and the head of the Ashram.",cta:{text:"Get the book",link:"/shop"},backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/tejas.png",title:"Tejas",description:"Tejas is the yogini who knows fire, she lives deep in the jungles.",cta:{text:"Get the book",link:"/shop"},backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/Callum_Bailey.png",title:"Callum",description:"Callum is a bright teenager from Glasgow, with a sunshine smile, he spreads happiness wherever he goes.",cta:{text:"Get the book",link:"/shop"},backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/Jaggu_baba.webp",title:"Jaggu Baba",description:"Jaggu Baba is an enigma, no one can understand what he really wants.",cta:{text:"Get the book",link:"/shop"},backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/book_bg_odd.png",title:"London reeling",description:"London reeling with relentless rains, this is where the story begins.",cta:{text:"Get the book",link:"/shop"},backgroundImageUrl:"somebackgroundImageURL"},{bookImageUrl:"/images/book_bg_even.webp",title:"The Himalayas",description:"The Himalayas near Jispa.",cta:{text:"Get the book",link:"/shop"},backgroundImageUrl:"somebackgroundImageURL"}]}},y=i.ZP.div`
    display: flex;
    flex-direction: column;
  `;function HomeLandingPage(e){let{learnMoreClick:o=d(),exploreBookClick:t=d()}=e.actions||{},{bannerData:a=[],aboutBook:r={},bookJourney:i=[]}=f.result;return(0,n.jsxs)(y,{children:[n.jsx(BannerContent,{exploreBookClick:t,bannerData:a}),n.jsx(AboutBook,{learnMoreClick:o,aboutBook:r}),n.jsx(BookJourney,{bookJourney:i,learnMoreClick:o})]})}let j=i.ZP.div`
